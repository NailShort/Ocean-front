  ...
  <div id="wf">
    <div class="contant row">
      <div class="title col-12">
        <div class="ch">隆頭魚</div>
        <div class="eg">Wrasse Fish</div>
      </div>
      <!-- 路徑 -->
      <div class="route col-12 row items-center justify-start">
        ...
        <span>></span>
        <q-btn :disable="!progress" flat style="color: gray" label="隆頭魚" />
      </div>
      <!-- 卡片 -->
...
(async () => {
  try {
    const { data } = await api.get('/fishs/category?category=隆頭魚')
