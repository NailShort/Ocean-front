  ...
  <div id="cf">
    <div class="contant row">
      <div class="title col-12">
        <div class="ch">草莓魚</div>
        <div class="eg">Pseudochromis Fish</div>
      </div>
      <!-- 路徑 -->
      <div class="route col-12 row items-center justify-start">
        ...
        <span>></span>
        <q-btn :disable="!progress" flat style="color: gray" label="草莓魚" />
      </div>
      <!-- 卡片 -->
...
(async () => {
  try {
    const { data } = await api.get('/fishs/category?category=草莓魚')
