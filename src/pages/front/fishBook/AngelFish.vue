  ...
  <div id="af">
    <div class="contant row">
      <div class="title col-12">
        <div class="ch">大型神仙</div>
        <div class="eg">Angle Fish</div>
      </div>
      <!-- 路徑 -->
      <div class="route col-12 row items-center justify-start">
        ...
        <span>></span>
        <q-btn :disable="!progress" flat style="color: gray" label="大型神仙" />
      </div>
      <!-- 卡片 -->
...
(async () => {
  try {
    const { data } = await api.get('/fishs/category?category=大型神仙')
